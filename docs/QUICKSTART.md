...
Windows is the primary desktop platform for this release. The CLI and local
service are continuously built, tested, and smoke-tested on Linux and macOS;
the desktop application is not packaged or verified on those platforms.
