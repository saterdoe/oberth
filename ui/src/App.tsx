...
function SettingsView({providers,projects,onChanged}:{providers:Provider[];projects:Project[];onChanged:()=>Promise<void>}){
  return <main className="panel settings-view"><LanguageSettings/><CodeIndexSettings projects={projects}/><SemanticSearchSettings onChanged={onChanged}/><SettingsPanel providers={providers} onChanged={onChanged}/></main>
}
