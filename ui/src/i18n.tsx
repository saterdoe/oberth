...
const codeIndexEn={
  ...
  'codeMap.explore':'Explore relationships','codeMap.title':'Code Map','codeMap.close':'Close Code Map','codeMap.search':'Find a file or module','codeMap.searchPlaceholder':'Path or name','codeMap.searchAction':'Search','codeMap.view':'View mode','codeMap.graph':'Graph','codeMap.table':'Table','codeMap.results':'Files and modules','codeMap.loading':'Loading relationships…','codeMap.noNodes':'No matching nodes.','codeMap.error':'The Code Map could not be loaded.','codeMap.direction':'Direction','codeMap.both':'Both','codeMap.incoming':'Incoming','codeMap.outgoing':'Outgoing','codeMap.current':'Current index','codeMap.stale':'Stale index','codeMap.indexed':'Indexed: {date}','codeMap.coverage':'{nodes} nodes · {edges} relationships','codeMap.truncated':'Limited result · {count} more','codeMap.selected':'Selected','codeMap.choose':'Choose a file or module','codeMap.chooseDetail':'The explorer will show its direct relationships and the source evidence.','codeMap.source':'Source','codeMap.relation':'Relationship','codeMap.target':'Target','codeMap.evidence':'Evidence','codeMap.ask':'Ask Oberth about this','codeMap.askPrompt':'Explain the direct code relationships around {name} ({path}), citing the source evidence. Do not modify files. If I later request a change, propose an implementation plan for review first.',
} as const
const codeIndexEs:{[K in keyof typeof codeIndexEn]:string}={
  ...
  'codeMap.explore':'Explorar relaciones','codeMap.title':'Mapa de código','codeMap.close':'Cerrar mapa de código','codeMap.search':'Buscar un archivo o módulo','codeMap.searchPlaceholder':'Ruta o nombre','codeMap.searchAction':'Buscar','codeMap.view':'Modo de visualización','codeMap.graph':'Grafo','codeMap.table':'Tabla','codeMap.results':'Archivos y módulos','codeMap.loading':'Cargando relaciones…','codeMap.noNodes':'No hay nodos que coincidan.','codeMap.error':'No se pudo cargar el mapa de código.','codeMap.direction':'Dirección','codeMap.both':'Ambas','codeMap.incoming':'Entrantes','codeMap.outgoing':'Salientes','codeMap.current':'Índice actualizado','codeMap.stale':'Índice desactualizado','codeMap.indexed':'Indexado: {date}','codeMap.coverage':'{nodes} nodos · {edges} relaciones','codeMap.truncated':'Resultado limitado · faltan {count}','codeMap.selected':'Seleccionado','codeMap.choose':'Elegí un archivo o módulo','codeMap.chooseDetail':'El explorador mostrará sus relaciones directas y la evidencia en el código.','codeMap.source':'Origen','codeMap.relation':'Relación','codeMap.target':'Destino','codeMap.evidence':'Evidencia','codeMap.ask':'Preguntarle a Oberth','codeMap.askPrompt':'Explicá las relaciones directas del código alrededor de {name} ({path}) y citá la evidencia fuente. No modifiques archivos. Si después pido un cambio, proponé primero un plan de implementación para revisar.',
}
const sessionEn={
...
const en={
  ...
  'tour.open':'Open guided tour','tour.launcher':'Guided tour','tour.title':'Product tour','tour.close':'Close tour','tour.step':'Step {current} of {total}','tour.skip':'Skip tour','tour.back':'Back','tour.next':'Next','tour.finish':'Finish',
  ...
  'tour.memory.title':'Memory improves with your judgment','tour.memory.body':'Vault keeps only the useful context you approve, so future tasks need less history while preserving important decisions.','tour.memory.hint':'You can reopen this tour from “Guided tour” in the sidebar.',
...
const es:Messages={
  ...
  'tour.open':'Abrir recorrido guiado','tour.launcher':'Recorrido guiado','tour.title':'Recorrido del producto','tour.close':'Cerrar recorrido','tour.step':'Paso {current} de {total}','tour.skip':'Omitir recorrido','tour.back':'Atrás','tour.next':'Siguiente','tour.finish':'Finalizar',
  ...
  'tour.memory.title':'La memoria mejora con tu criterio','tour.memory.body':'Memoria conserva únicamente el contexto útil que aprobás, para que las próximas tareas necesiten menos historial y mantengan decisiones importantes.','tour.memory.hint':'Podés volver a abrir este recorrido desde «Recorrido guiado» en la barra lateral.',
