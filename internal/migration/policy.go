...
var Formats = []Format{
	...
	{Name: "database", Owner: "internal/db", CurrentVersion: "28", Storage: "PostgreSQL schema_migrations", Rollback: "restore the operator-created database backup; down migrations are development-only"},
